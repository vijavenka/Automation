Feature: IAT ADMIN - lite version of the send ecard UI for workAnniversary
...
When Work anniversary event is selected
...
Then Points have been sent message will be displayed on top right on desktop, and botton for mobile
Then check userA envelope image changes to blue
