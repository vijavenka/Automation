--
-- Script containing dummy data to initialise a database for demo purposes.
--
...
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(13, '2013-05-17 11:20:50', 'affiliateKey', 'ADD_POINTS', true, 12, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(14, '2013-05-18 14:12:50', 'accessKey', 'ADD_POINTS', true, 13, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(15, '2013-05-18 14:20:50', 'accessKey', 'ADD_POINTS', true, 14, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(16, '2013-05-18 14:30:50', 'accessKey', 'ADD_POINTS', true, 15, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(17, '2013-05-19 11:20:50', 'affiliateKey', 'ADD_POINTS', true, 16, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(18, '2013-05-19 11:51:50', 'affiliateKey', 'ADD_POINTS', true, 17, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(19, '2013-05-21 10:18:50', 'affiliateKey', 'CHANGE_PENDING_TO_DECLINED', true, 17, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(20, '2013-05-20 11:30:50', 'accessKey', 'ADD_POINTS', true, 18, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(21, '2013-05-21 11:30:50', 'accessKey', 'ADD_POINTS', true, 19, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(22, '2013-05-21 14:30:50', 'accessKey', 'ADD_POINTS', true, 20, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(23, '2013-05-22 11:30:50', 'accessKey', 'ADD_POINTS', true, 21, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(24, '2013-05-23 11:30:50', 'accessKey', 'ADD_POINTS', true, 22, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(25, '2013-05-24 11:30:50', 'accessKey', 'ADD_POINTS', true, 23, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(26, '2013-05-25 11:12:50', 'affiliateKey', 'ADD_POINTS', true, 24, 'email@domain.com', 'EMAIL');
insert into Request(id, createdAt, apiAccessKey, requestType, success, pointsId, userId, idType) values(27, '2013-05-28 00:00:00', 'affiliateKey', 'CHANGE_PENDING_TO_CONFIRMED', true, 24, 'email@domain.com', 'EMAIL');
