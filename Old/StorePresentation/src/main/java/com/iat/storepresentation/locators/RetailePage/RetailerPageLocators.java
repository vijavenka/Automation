package com.iat.storepresentation.Locators.RetailePage;
 ...
 */
public class RetailerPageLocators {
...
//Modal window trust pilot Locators
    ...
    public Locator goToRetailerButton = new Locator(LocatorType.XPATH, "//div[@class='section top-section']//a[@class='retailerLink btn branded']");
//Special offers block
    ...
    public Locator specialOffersPercentageSaving = new Locator(LocatorType.XPATH, "//div[@id='retailerSpecialOffersRegion']//div[@class='product-card-view']//div[@class='percent-saving branded']");
    ...
    public Locator specialOffersBuyButton = new Locator(LocatorType.XPATH, "//div[@id='retailerSpecialOffersRegion']//div[@class='product-card-view']//a[@class='buy-button']");
...
//Vouchers block
    ...
    public Locator voucherDescription = new Locator(LocatorType.XPATH, "//div[@id='retailerVouchersRegion']//div[@class='voucherbox']//p[@class='voucherDescription']");
    public Locator voucherButtonGet = new Locator(LocatorType.XPATH, "//article[@class='module-container type-voucher']//a[@class='get-voucher-codes']");
    public Locator voucherExpiresDate = new Locator(LocatorType.XPATH, "//article[@class='module-container type-voucher']//span[@class='voucherExpire']");
    public Locator voucherCode = new Locator(LocatorType.XPATH, "//div[@class='voucherCode branded'] ");
    public Locator voucherOpenSiteButton = new Locator(LocatorType.XPATH, "//div[@class='voucherRetailerSite branded']  ");
...
//Similar products block
    ...
    public Locator similarRetailersBasicRetailerCard = new Locator(LocatorType.XPATH, "//div[@id='similarRetailersRegion']//li[2]");
