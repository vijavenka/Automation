package com.iat.storepresentation.Steps.RetailerPage;

import com.iat.storepresentation.Executors.IExecutor;
import com.iat.storepresentation.Executors.SeleniumExecutor;
import com.iat.storepresentation.Navigations.RetailerPage.RetailerPageNavigation;
 ...
 */
public class RetailerPageSteps {

    private IExecutor executor;
    private RetailerPageNavigation retailerNavi;
    private TransitionPageNavigation transitionNavi;


    public RetailerPageSteps(SeleniumExecutor executor) {
    ...
    public void set_up() {
        ...
        retailerNavi = new RetailerPageNavigation(executor);
    }
    ...
    public void User_choose_a_retailer() throws Throwable{
        retailerNavi.openRetailerPage();
    }
    ...
    // RETAILER PAGE ON WLS - add retailer page interface (RD-1166) - no category block
    ...
    // RETAILER PAGE ON WLS - add retailer page interface (RD-1166) - no similar retailers block
