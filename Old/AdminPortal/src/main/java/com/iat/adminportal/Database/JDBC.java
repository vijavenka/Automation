package com.iat.adminportal.Database;
...
public class JDBC {
    ...
    // epoints /////////////////////////////////////////////////////////////////////////////////////////////////////////
    private String dbUrlEP = envVariables.getEpointsDbCredentials()[0];
    private String userEP = envVariables.getEpointsDbCredentials()[1];
    private String passEP = envVariables.getEpointsDbCredentials()[2];
    // admin ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    private String dbUrlAD = envVariables.getAdminPortalDbCredentials()[0];
    private String userAD = envVariables.getAdminPortalDbCredentials()[1];
    private String passAD = envVariables.getAdminPortalDbCredentials()[2];
    ...
    public JDBC(String whichDatabase) {
        ...
        try {
            ...
            } else if (whichDatabase.equals("admin_portal")) {
