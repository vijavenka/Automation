Feature: Epoints your account page
  As an epoints user
  I want to have purchase epoints section in your account page
  ...
  @purchaseEpointsTab @userAccount
  ...
  # // 1.3 //  ---------------------------------- EPOINTS - take payment for buying epoints - screen 1 confirm(NBO-1142)
  # -------------------------------------------------------------------- make sure user cannot spend less than 30 pounds
  # Update ------------------------------ EPOINTS - update purchase points page offering epoints/pound buckets(NBO-1440)
