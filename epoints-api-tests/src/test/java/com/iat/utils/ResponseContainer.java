...
public class ResponseContainer {
    ...
    public void validateContract(String contract) {
        new ContractValidator().validateResponseWithContract(contract, response);
    }
    ...
    public String getStatusLine() {
        return response.extract().response().getStatusLine();
    }
