...
class DateTimeUtil {
    ...
    static Date adjustTimeOfTheDay(Date date, int hour, int minute, int second, int millisecond) {
    ...
    static Date addUtcOffset(Date date) {
     ...
     * @return
     */
    static Date adjustDateBySeconds(Date date, int seconds) {
        return adjustDate(date, Calendar.SECOND, seconds)
    }

    static Date adjustDateByHours(Date date, int hours) {
        return adjustDate(date, Calendar.HOUR, hours)
    }

    static Date adjustDateByDays(Date date, int days) {
        return adjustDate(date, Calendar.DATE, days)
    }

    static Date adjustDateByYears(Date date, int years) {
        return adjustDate(date, Calendar.YEAR, years)
    }

    static Date adjustDateByMonths(Date date, int months) {
    ...
    static int getDateDay(Date date) {
        return getDatePart(date, Calendar.DAY_OF_MONTH)
    }

    static int getDateMonth(Date date) {
    ...
    static Date convertToDate(String dateString, String dateFormat, boolean originalWasUtc) {
    ...
    static Date convertToDate(String dateString, String dateFormat) {
        return convertToDate(dateString, dateFormat, false)
    }

    static String convertToString(Date date, String dateFormat, boolean shouldBeUtc) {
        DateFormat df = new SimpleDateFormat(dateFormat)
    ...
    static String convertToString(Date date, String dateFormat) {
        return convertToString(date, dateFormat, false)
    }

    static long diffBetweenDates(Date startDate, Date endDate, int value) {
