...
public class GenericSteps {
    ...
    public void getGenericErrorMessageValidation(String method, int status, String error, String message) throws Throwable {
        ...
        if (error.equals("null"))
            genericValidator.multipleFieldsErrorMessageValidation(message, dataExchanger.getResponse());
        else
            genericValidator.validateGenericErrorMessage(dataExchanger.getResponse(), error, message, status);

        dataExchanger.setResponse(null);
    }
